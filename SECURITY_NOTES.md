...
- Deploy backend separately (VPS/Render/Railway).
- Open your site with query:
```text
https://<login>.github.io/<repo>/?api=https://<your-backend-domain>/api
```
- First launch stores this API endpoint in browser localStorage and enables server mode.
